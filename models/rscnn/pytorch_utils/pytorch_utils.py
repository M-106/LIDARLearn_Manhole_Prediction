"""
RS-CNN — Vendored pytorch_utils

Paper: CVPR 2019
Authors: Yongcheng Liu, Bin Fan, Shiming Xiang, Chunhong Pan
Source: https://github.com/Yochengliu/Relation-Shape-CNN
License: MIT

SharedMLP, Conv1d/Conv2d wrappers, FC layers and other building
blocks copied from the original RS-CNN release.
"""
import torch
...
def load_checkpoint(model=None, optimizer=None, filename='checkpoint'):
    ...
    if os.path.isfile(filename):
        print_log("==> Loading from checkpoint '{}'".format(filename))
        ...
        print_log("==> Checkpoint '{}' not found".format(filename))
...
class CrossValSplitter():
    ...
    def print_metrics(self):
        for name, samples in self.metrics.items():
            ...
            print_log("{}: {} +/- {}".format(name, xbar, margin_of_error))
