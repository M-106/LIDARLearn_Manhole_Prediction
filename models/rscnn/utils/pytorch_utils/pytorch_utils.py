"""
RS-CNN — Vendored pytorch_utils (utils variant)
...
Duplicate of pytorch_utils kept under utils/ for the segmentation
entry point. Same SharedMLP / Conv wrappers as the top-level copy.
"""
import torch
