"""
RS-CNN — Vendored PointNet++ SA / FP modules
...
PointnetSAModuleMSG / PointnetFPModule with the relation-shape
convolution wired in as the local aggregator. Vendored from the
original RS-CNN release.
"""
import os
import sys
import torch
