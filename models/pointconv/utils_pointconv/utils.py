"""
PointConv — Generic helpers

Paper: CVPR 2019
Authors: Wenxuan Wu, Zhongang Qi, Li Fuxin
Source: https://github.com/DylanWusuper/PointConv
License: MIT

Generic helpers (index_points, square_distance, sample_and_group)
shared by every PointConv set-abstraction stage.
"""
# *_*coding:utf-8 *_*
import os
import numpy as np
