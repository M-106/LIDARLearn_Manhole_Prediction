"""
PointWeb — Shared MLP / conv helpers
...
SharedMLP, Conv2d/Conv1d wrappers and other small primitives used
throughout PointWeb. Vendored verbatim from the original repository.
"""
import shutil
import os
import tqdm
